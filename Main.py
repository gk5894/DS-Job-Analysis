...
# job roles
job_set = ['data+analyst','business+analyst','data+scientist','data+engineer']
...
for city in city_set:
    ...
    for job_qry in job_set:
        ...
        if(file > SKIPPER):
            ...
            # dataframe
            df = pd.DataFrame(columns = ['unique_id', 'city', 'job_qry','job_title', 'company_name', 'location', 'summary', 'salary', 'link', 'date'])
